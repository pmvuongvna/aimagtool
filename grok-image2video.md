...
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1775029352736_sgH2v6e5.png"]`
...
- **Default Value**: `"He is playing the guitar."`
...
```json
{
  ...
  "input": {
    "image_urls": ["https://static.aiquickdraw.com/tools/example/1775029352736_sgH2v6e5.png"],
    "task_id": undefined,
    "index": 42,
    "prompt": "He is playing the guitar.",
    "mode": "normal",
    "aspect_ratio": "2:3",
    "duration": 6,
    "resolution": "480p",
...
```json
{
  ...
  "data": {
    ...
    "model": "grok-imagine/image-to-video",
    "state": "waiting",
    "param": "{\"model\":\"grok-imagine/image-to-video\",\"input\":{\"image_urls\":[\"https://static.aiquickdraw.com/tools/example/1775029352736_sgH2v6e5.png\"],\"index\":42,\"prompt\":\"He is playing the guitar.\",\"mode\":\"normal\",\"aspect_ratio\":\"2:3\",\"duration\":6,\"resolution\":\"480p\",\"nsfw_checker\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1775029498799_9HJRSiTP.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
